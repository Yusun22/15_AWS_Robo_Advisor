    ...
    if amount is not None:
        ...
        if amount < 5000:
            return build_validation_result(
                ...
                "please provide a valid amount in USD.",
            )
...
def get_recommendation(risk_level):
    ...
    recommendation = ""
    if risk_level == "none" :
        recommendation = "The recommended portfolio build is 100% bonds (AGG), 0% equities (SPY)"
    elif risk_level == "low":
        recommendation = "The recommended portfolio build is 60% bonds (AGG), 40% equities (SPY)"
    elif risk_level == "medium" :
        recommendation = "The recommended portfolio build is 40% bonds (AGG), 60% equities (SPY)"
    elif risk_level == "high":
        recommendation = "The recommended portfolio build is 20% bonds (AGG), 80% equities (SPY)"
    else:
